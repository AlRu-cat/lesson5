...
# Если в списке klasses меньше элементов,
...
list_of_members = ((names, number) for names, number in zip_longest(tutors, klasses, fillvalue='None'))


print(next(list_of_members))
print(next(list_of_members))
print(next(list_of_members))
print(next(list_of_members))
print(next(list_of_members))
